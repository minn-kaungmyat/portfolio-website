...
const NavDropDown = (props) => (
  <DropDownContainer active={props.isOpen}>
    <DropDownItem href="tel:+959964331230" target="_blank" rel="noreferrer">
      <DropDownIcon>
        <AiFillPhone/>
      </DropDownIcon>
    ...
    <DropDownItem href="mailto:minnkaungmyat00@gmail.com" target="_blank" rel="noreferrer">
      <DropDownIcon>
      <AiOutlineMail/>
      </DropDownIcon>
      <DropDownTextContainer>
    ...
    <DropDownItem href="#" target="_blank" rel="noreferrer">
      ...
      <DropDownTextContainer>
        ...
        <DropDownItemDesc>9/474, Sayar Tin Street, Dagon Myothit (East)</DropDownItemDesc>
      </DropDownTextContainer>
    </DropDownItem>
  </DropDownContainer>
);
